...
ARTISTIC_STYLE_PROMPTS = {
    "🌂 Magritte": (
        "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above. The subject identity is described in the SUBJECT IDENTITY section above — preserve face, beard, glasses, hair exactly. Reinterpret in the style of René Magritte: surrealist hyper-realism, dreamlike impossible juxtapositions, objects out of context, Belgian surrealism aesthetic. Palette: cool grey, ivory, soft pastel tones. Solid colors only, no patterns. Background: seamless white studio or minimal dreamlike setting. Maintain photographic quality with a painted surrealist atmosphere."
    
    ),
    "🌀 Dalì": (
        "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above. The subject identity is described in the SUBJECT IDENTITY section above — preserve face, beard, glasses, hair exactly. Reinterpret in the style of Salvador Dalì: melting surrealist dreamscape, hyper-detailed hallucination, elongated surreal elements, Spanish surrealism. Palette: earthy terracotta, ochre, warm amber. Solid colors only, no patterns. Background: desert at golden hour or vast dreamlike landscape. Ultra-detailed with a painted surrealist atmosphere."
    
    ),
    "🏛️ De Chirico": (
        "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above. The subject identity is described in the SUBJECT IDENTITY section above — preserve face, beard, glasses, hair exactly. Reinterpret in the style of Giorgio De Chirico: metaphysical painting aesthetics, long dramatic shadows, eerie stillness, classical architecture elements, empty piazzas. Palette: earthy terracotta, warm ivory, cool grey. Solid colors only, no patterns. Background: ancient ruins or empty classical piazza with dramatic shadows. Wide angle full body composition preferred."
    
    ),
    "🔷 Mondrian": (
        "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above. The subject identity is described in the SUBJECT IDENTITY section above — preserve face, beard, glasses, hair exactly. Reinterpret in the style of Piet Mondrian and De Stijl: primary color geometric grid, flat bold rectangles of red, blue, yellow, black and white. Solid colors only, no patterns. Background: white seamless or geometric grid. Flat 2D graphic quality with bold black outlines separating color blocks."
    
    ),
    "🖌️ Banksy": (
        "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above. "
        "The subject identity is described in the SUBJECT IDENTITY section above — preserve face, beard, glasses, hair exactly. "
        "Transform into urban stencil art in the style of Banksy: black and white spray paint aesthetic, "
        "sharp political and artistic irony, graffiti on a brick wall or urban surface. "
...
FILTERS = {
    ...
    "cinematic_highangle": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Generate a cinematic high-angle portrait of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "dramatic": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Generate a dramatic low-to-high angle shot of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "glossy": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Generate a hyper-glamour image of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "iridescent": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Generate an iridescent editorial image of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "galaxy": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Generate a jewel galaxy haute couture editorial of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "arabesque": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Generate a baroque maximalist editorial of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "stained_glass": {
        ...
        "cat": "fantasy",
        "prompt": (
            "Transform the subject and outfit described in the OUTFIT REFERENCE above into a hyper-realistic figure "
    ...
    "underwater": {
        ...
        "cat": "fantasy",
        "prompt": (
            "Generate a high-fantasy underwater image of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "3d_synthetic": {
        ...
        "cat": "fantasy",
        "prompt": (
            "Generate a hyper-realistic cutting-edge 3D rendering of the subject and outfit described in the OUTFIT REFERENCE above. "
    ...
    "graffiti": {
        ...
        "cat": "fantasy",
        "prompt": (
            "Generate an ultra-realistic image of the subject described in the OUTFIT REFERENCE above "
            "spray-painting a full-body self-portrait graffiti on an urban brick wall. "
            "The subject wears the exact outfit described in the OUTFIT REFERENCE. "
    ...
    "cloud_sculpture": {
        ...
        "use_master": False,
        "prompt": (
            "Transform the subject described in the OUTFIT REFERENCE above into a form made entirely of soft billowing clouds. "
    ...
    "lego": {
        ...
        "prompt": (
            ...
            "described in the OUTFIT REFERENCE above. "
    ...
    "dissolve": {
        ...
        "use_master": False,
        "prompt": (
            "Generate a portrait of the subject described in the OUTFIT REFERENCE above dissolving into fluid motion trails. "
            "The subject wears the exact outfit described in the OUTFIT REFERENCE. "
    ...
    "ghost_temporal": {
        ...
        "prompt": (
            ...
            "described in the OUTFIT REFERENCE above, framed from mid-thigh up. "
    ...
    "long_exposure": {
        ...
        "use_master": False,
        "prompt": (
            "Recreate the subject and outfit described in the OUTFIT REFERENCE above as a long exposure fashion photograph. "
    ...
    "giantess": {
        ...
        "cat": "scenic",
        "prompt": (
            "Generate a hyper-realistic photograph of the subject described in the OUTFIT REFERENCE above "
    ...
    "action_figure": {
        ...
        "cat": "scenic",
        "prompt": (
            "Create a 1/7 scale commercial figure of the subject described in the OUTFIT REFERENCE above, "
            "wearing the exact outfit described in the OUTFIT REFERENCE, "
    ...
    "art_doll": {
        ...
        "prompt": (
            ...
            "wearing clothing style, hairstyle and accessories identical to those described in the OUTFIT REFERENCE above. "
            "The sculpture is 50% taller than a real person and stands naturally behind and slightly to the side of the subject. "
            "The subject described in the OUTFIT REFERENCE stands in the foreground — face and pose natural. "
    ...
    "toy_window": {
        ...
        "prompt": (
            ...
            "same features, same hair, same outfit as in the OUTFIT REFERENCE, "
    ...
    "new_pose": {
        ...
        "cat": "collage",
        "prompt": (
            "Generate a new image of the subject and outfit described in the OUTFIT REFERENCE above "
    ...
    "triptych": {
        ...
        "cat": "altri",
        "prompt": (
            "Generate a 3:1 collage of the subject and outfit described in the OUTFIT REFERENCE above, "
    ...
    "pastel_clones": {
        ...
        "prompt": (
            ...
            "described in the OUTFIT REFERENCE above. "
            "Each clone wears the exact outfit described in the OUTFIT REFERENCE — "
            ...
            "The subject outfit and skin tones are NOT pastelized — they remain true to the OUTFIT REFERENCE description. "
    ...
    "collage_2x2": {
        ...
        "use_master": False,
        "prompt": (
            "Generate a 2x2 quad-panel collage of the subject and outfit described in the OUTFIT REFERENCE above, "
            "with four completely different camera angles and poses. "
            "All four panels must show the same subject with the exact outfit from the OUTFIT REFERENCE consistently. "
    ...
    "photobooth_4x4": {
        ...
        "use_master": False,
        "prompt": (
            "Generate a color photobooth expression grid of the subject and outfit described in the OUTFIT REFERENCE above, "
    ...
    "fullbody_3x3": {
        ...
        "use_master": False,
        "prompt": (
            "Generate a full body editorial grid of the subject and outfit described in the OUTFIT REFERENCE above, "
    ...
    "pet_mosaic": {
        ...
        "use_master": False,
        "prompt": (
            "Generate a color expression grid of the animal described in the OUTFIT REFERENCE above, "
...
def _run_generation(chat_id, uid, username, data):
    ...
    try:
        full_prompt = (
            ...
            f"The following description was extracted from the reference photo. "
