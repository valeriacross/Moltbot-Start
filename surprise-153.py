...
LOCATION_POOL = [
    ...
    "Lisbon Belém Tower riverside, Tagus at golden hour",
    "Almada Cacilhas waterfront, Lisbon skyline across the river",
    "Algarve golden sea cliffs, Praia da Marinha, turquoise water",
    "Porto Ribeira coloured houses, Douro riverfront, warm light",
    "Aveiro canals, moliceiro boats, Art Nouveau facades",
    "Milan Duomo cathedral square, Gothic pinnacles, blue sky",
    "Turin Mole Antonelliana rooftop, alpine skyline at dusk",
    "Rome Piazza Navona, baroque fountains, golden afternoon",
    "Venice Piazza San Marco at dawn, empty, long shadows",
    "Florence Piazzale Michelangelo, panoramic Arno view, sunset",
...
OUTFIT_POOL = [
    # Abiti da sera / gala
    "floor-length black Versace gown, plunging neckline, gold chain belt",
    "ivory silk Valentino ballgown, cathedral train, long gloves",
    "red Marchesa strapless evening gown, floral embroidery",
    "midnight blue Armani Privé velvet dress, cape sleeves",
    "silver sequined Balmain mini dress, structured shoulders",
    "emerald green Elie Saab gown, sheer lace bodice, slit",
    "white Giambattista Valli tulle ball gown, voluminous skirt",
    "black Givenchy tuxedo suit, silk lapels, palazzo trousers",
    "cobalt blue Roland Mouret crepe column dress",
    "gold lamé Versace jumpsuit, deep V, wide leg",
    # Beachwear / resort
    "Victoria's Secret gold metallic bikini, sarong wrap",
    "white one-piece swimsuit, open back, gold hardware",
    "printed Missoni kaftan, strappy sandals, sun hat",
    "black Eres high-waist bikini, oversized straw hat",
    "coral La Perla bikini, sheer cover-up, espadrilles",
    "leopard print Norma Kamali swimsuit, cat-eye sunglasses",
    "red Baywatch-style one-piece, vintage inspired",
    # Street / casual chic
    "wide-leg white linen trousers, silk camisole, loafers",
    "black leather Balmain blazer, mini skirt, ankle boots",
    "camel Bottega Veneta coat, cashmere turtleneck, wide trousers",
    "floral Dolce & Gabbana midi dress, platform sandals",
    "white Chanel tweed suit, pearl necklace, slingback pumps",
    "blue pinstripe Max Mara power suit, silk blouse",
    # Avant-garde
    "sculptural Alexander McQueen structured jacket, pencil skirt",
    "geometric Issey Miyake pleated dress, architectural silhouette",
    "black latex Alaïa bodycon dress, cut-out details",
    "feathered Valentino Haute Couture mini dress, stilettos",
    "Iris van Herpen 3D-printed sculptural gown",
    "Thierry Mugler metal corset bodysuit, wide skirt",
    "Rick Owens draped leather coat, platform boots",
    # Sportswear / activewear chic
    "Victoria's Secret Angel wings look, rhinestone bodysuit",
    "white tennis dress, Wimbledon look, visor, white sneakers",
    "cycling shorts, oversized blazer, heels, Balenciaga style",
]
