...
OUTFIT_POOL = [
    ...
    ("Alaia · cut-out one-piece · ivory white",           "ivory white Alaia one-piece, deep V front, cut-out waist, high-cut legs, white slide sandals, gold cuff"),
    ...
    ("Alaia · laser-cut bodycon · deep violet",           "deep violet Alaia laser-cut bodycon, geometric openwork, violet patent heels, single silver cuff"),
