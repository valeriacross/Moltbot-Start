...
def get_mode_keyboard():
    ...
    markup.row(
        ...
        InlineKeyboardButton("🎥 Video (beta)", callback_data="vogue_mode_video"),
    )
    return markup
...
def handle_vogue_callback(call):
    ...
    if data == "vogue_mode_image":
        ...
        bot.send_message(cid, "📷 <b>Modalità Immagine.</b> Inviami una foto.")

    elif data == "vogue_mode_video":
        pending_mode[uid] = "video"
        bot.send_message(cid,
            "🎥 <b>Modalità Video (beta).</b> Inviami un video — max 20MB, clip brevi "
