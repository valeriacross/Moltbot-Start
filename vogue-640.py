...
def generate_caption_from_text(prompt_text):
    """Genera caption social dal testo del prompt, senza immagine."""
    try:
        response = client.models.generate_content(
            model=MODEL_TEXT_ID,
            contents=[
                f"Based on this image generation prompt, write a social media caption. "
                f"1 complete sentence in English, 3-5 emojis, fashion-forward tone, mention location or outfit. "
