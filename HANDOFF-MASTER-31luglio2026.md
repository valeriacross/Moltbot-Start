...
**Generato:** 31/07/2026, fine sessione (aggiornato da versione 28/07)
**Da:** Walter Caponi
...
## 2. STATO FILE ATTUALE (31/07/2026)

| File | Versione | Koyeb service | Run command | Chiavi API |
|------|---------|---------------|--------------|-----------|
| `C_shared100.py` | **2.4.8** | (comune a tutti) | — | — |
...
## 4. C_SHARED100.PY — STORICO COMPLETO FIX (v2.3.0 → v2.4.8)
