...
from C_shared100 import VALERIA_DNA, EDITORIAL_WRAPPER, build_valeria_identity, generate_caption, generate_mini_caption, generate_mini_prompt
...
def handle_photo(m):
    ...
    def _process():
        ...
        if flt.get("shooting"):
            ...
            mode_label = "🗂️ Mosaico 4 foto" if mode == "mosaic" else "📷 Scatti separati"
            full_p = build_shooting_prompt(outfit_desc, mode)
