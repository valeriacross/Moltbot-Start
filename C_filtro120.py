...
FILTERS = {
    ...
    "cinematic_highangle": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Apply a photographic filter. The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. "
    ...
    "dramatic": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Apply a photographic filter. The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Apply an extreme low-to-high angle, sharply focusing on the foreground. "
    ...
    "glossy": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Apply the 'Ultra-Opal Fairy-Angel Couture V2' style. The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing.  hyper-glamour rendering with 3D iridescent aesthetics, "
    ...
    "iridescent": {
        ...
        "cat": "stylistic",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Rendered with an extreme iridescent and opalescent finish. The lighting must use dichroic refraction to create "
    ...
    "galaxy": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Apply an exclusive 'jewel galaxy haute couture' aesthetic filter. The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. "
    ...
    "arabesque": {
        ...
        "cat": "stylistic",
        "prompt": (
            "Transform this image into an explosion of supreme opulence — preserving the EXACT outfit described in the OUTFIT REFERENCE section above.  and baroque maximalism. "
    ...
    "stained_glass": {
        ...
        "cat": "fantasy",
        "prompt": (
            "Apply this filter: The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Transform the subject into a hyper-realistic figure made entirely of stained glass and translucent crystal. "
    ...
    "underwater": {
        ...
        "cat": "fantasy",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. High-fantasy underwater style with high-brilliance gold and saturated turquoise/teal palette, "
    ...
    "3d_synthetic": {
        ...
        "cat": "fantasy",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Generate a hyper-realistic cutting-edge 3D rendering. Transform the subject's material "
    ...
    "graffiti": {
        ...
        "cat": "fantasy",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Create one ultra-realistic image of the subject spray-painting a full-body "
    ...
    "cloud_sculpture": {
        ...
        "use_master": False,
        "prompt": (
            "Using the OUTFIT REFERENCE section above as reference, transform the subject — "
    ...
    "lego": {
        ...
        "cat": "fantasy",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Ultra-photorealistic LEGO brick-built the subject, constructed entirely from authentic LEGO bricks, plates, tiles, "
    ...
    "dissolve": {
        ...
        "use_master": False,
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Portrait dissolving into fluid motion trails as if the subject is melting into liquid light. "
    ...
    "ghost_temporal": {
        ...
        "use_master": False,
        "prompt": (
            "Using the OUTFIT REFERENCE section above as the identity and style reference, create an ultra-realistic 8K cinematic studio portrait "
            "framed from mid-thigh up. "
            "IDENTITY LOCK: Preserve the subject's identity — same face, facial structure, skin tone, hair, and use the EXACT outfit described in the OUTFIT REFERENCE section above. "
            "BACKGROUND: Vibrant ochre-red background (#C0392B), uniform but subtly graded for depth. "
            "OUTFIT: Preserve exactly the outfit described in the OUTFIT REFERENCE section above — same garments, colors, textures, "
    ...
    "giantess": {
        ...
        "cat": "scenic",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. A hyper-realistic photograph of a giant human subject. "
    ...
    "action_figure": {
        ...
        "cat": "scenic",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Create a 1/7 scale commercial figure of the subject, in a realistic style set in a real environment. "
    ...
    "art_doll": {
        ...
        "prompt": (
            ...
            "with clothing style, hairstyle and accessories 100% identical to those described in the OUTFIT REFERENCE section above. "
    ...
    "toy_window": {
        ...
        "cat": "scenic",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Generate an ultra-realistic image of the subject, using its proportions and format. "
    ...
    "selfie_stick": {
        ...
        "use_master": False,
        "prompt": (
            "Using the OUTFIT REFERENCE section above as identity reference, generate a new editorial photograph in selfie stick POV style. "
            ...
            "IDENTITY LOCK: Preserve the subject's identity — same face, facial structure, skin tone, hair, and use the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, shoes, accessories. "
    ...
    "new_pose": {
        ...
        "cat": "collage",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Create a new image using the exact same scene and identity as the OUTFIT REFERENCE section above, "
    ...
    "triple_set": {
        ...
        "cat": "collage",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Generate a set of 3 separate and different images in high resolution, "
    ...
    "triptych": {
        ...
        "cat": "altri",
        "prompt": (
            "The subject wears the EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same fabrics, same accessories. Do not alter, replace or invent any clothing. Create a 3:1 collage of three versions with completely different poses and facial expressions, seed: random. "
    ...
    "pastel_clones": {
        ...
        "use_master": False,
        "prompt": (
            "Ultra-realistic high-fashion editorial collage with 7 clones of the subject described in the OUTFIT REFERENCE section above. "
            ...
            "OUTFIT: Each clone wears the EXACT EXACT outfit described in the OUTFIT REFERENCE section above — same garments, same colors, same cut, same accessories. "
    ...
    "collage_2x2": {
        ...
        "use_master": False,
        "prompt": (
            "Using the OUTFIT REFERENCE section above as the identity and style reference, create a 2×2 quad-panel collage "
            ...
            "All four panels must show the same subject with the outfit described in the OUTFIT REFERENCE section above, consistently. "
            ...
            "Adapt the lighting and environment from the OUTFIT REFERENCE description across all four panels. "
    ...
    "photobooth_4x4": {
        ...
        "use_master": False,
        "prompt": (
            "Using the OUTFIT REFERENCE section above as the identity and style reference, create a color photobooth expression grid "
            ...
            "SETTING: Use the background environment and lighting mood described in the OUTFIT REFERENCE section above, "
    ...
    "pet_mosaic": {
        ...
        "use_master": False,
        "prompt": (
            "Using the OUTFIT REFERENCE section above as the identity reference, create a color expression grid "
            ...
            "IDENTITY LOCK: Preserve the exact animal — same breed, fur color, fur texture, "
...
# --- 3D STEREO ---
STEREO_PROMPT = (
    "Analyze the outfit description in the OUTFIT REFERENCE section above carefully. "
...
def _build_mirror_prompt(outfit_desc):
    ...
    return (
        f"OUTFIT REFERENCE — LOCKED — DO NOT ALTER:\n"
        f"{outfit_desc}\n\n"
...
def _run_mirror(chat_id, uid, username, img_bytes):
    ...
    try:
        # Analisi outfit reale dall'immagine — fino a 5 tentativi
        ...
        if not outfit_desc:
            bot.send_message(chat_id, f"⚠️ {err}\n\nNessun prompt generato — riprova con un'altra foto.")
...
def handle_photo(m):
    ...
    if mirror_waiting.pop(uid, False):
        ...
        if not outfit_desc:
            bot.send_message(m.chat.id, f"⚠️ {err}\n\nNessun prompt generato — riprova con un'altra foto.")
            return
        prompt = _build_mirror_prompt(outfit_desc)
...
FULLBODY_3X3_BASE = (
    "Using the OUTFIT REFERENCE section above as the identity and style reference, create a full body editorial grid "
...
def _run_generation(chat_id, uid, username, data):
    ...
    # --- ANALISI OUTFIT REALE (fino a 5 tentativi) ---
    ...
    if not outfit_desc:
        bot.send_message(chat_id,
            f"❌ <b>Analisi outfit fallita dopo 5 tentativi.</b>\n"
    ...
    try:
        full_prompt = (
            f"OUTFIT REFERENCE — LOCKED — DO NOT ALTER:\n"
            f"The following outfit description was extracted from the reference photo. "
            f"It is MANDATORY and must be reproduced identically in the generated image. "
            f"DO NOT alter, replace, remove or add any garment or accessory.\n\n"
            f"{outfit_desc}\n\n"
            f"{EDITORIAL_WRAPPER}{filter_prompt}"
        )
        last_prompt[uid] = full_prompt
