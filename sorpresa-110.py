...
FX_FORMATO = {
    ...
    "☁️ Cloud Sculpture — body sculpted entirely from dense cumulus clouds, whipped cream cloud texture, sky installation art": "1:1",
}
...
def get_formato(combo):
    ...
    # 5. Sfondo quadrato/neutro
    if sfondo in SFONDI_QUADRATI:
        return random.choice(["4:5", "1:1"])
...
def estrai_combinazione():
    ...
    Applica cascata di compatibilità su 6 assi:
    ...
    # 9. Calcola formato ottimale in base alla combo finale
