...
awaiting_photo = {}   # uid → True se bot aspetta foto location (4.0)
photo_location = {}   # uid → descrizione testuale estratta da Gemini Vision (4.0)
photo_part     = {}   # uid → genai Part della foto originale (4.0)
...
def handle_callback(call):
    ...
    # 4.0 — utente vuole caricare foto location
