...
from C_shared100 import GeminiClient, CaptionGenerator, HealthServer, is_allowed, analyze_scene, SHARED_VERSION, SHARED_DATE
...
def handle_location_photo(m):
    ...
    if not location_text:
        bot.send_message(cid,
            "❌ Impossibile analizzare la foto.\n\nProcedo senza foto — scegli il formato:",
