...
def execute_generation(full_prompt, img_rif_bytes=None):
    try:
        ...
        # MASTER_PART deve essere il PRIMO elemento — critico per integrazione volto
        if MASTER_PART:
    ...
    if m.content_type == 'photo':
        ...
        if not user_text or len(user_text.strip()) < 30:
            ...
            pending_prompts[uid] = {
                ...
                'qty': qty,
                'img': None,  # T2I puro — nessuna immagine di riferimento
            }
...
def handle_choice(call):
    ...
    if call.data == "choice_faceswap":
        ...
        def do_faceswap():
            ...
            pending_prompts[uid] = {'full_p': faceswap_prompt, 'qty': qty, 'img': None}  # T2I puro
            user_last_prompt[uid] = {'full_p': faceswap_prompt, 'img': None}
