...
| `Atelier_205.py` | **2.0.5** | flexible-denna/atelier | `python Atelier_205.py` | 5 |
...
## 7. ATELIER — STORICO E STATO (v2.0.5)
...
11. **TODO aperto (08/07) — test da fare per Vogue e Atelier, NON per Architect (superato):** nessuno dei 2 file toccati per la clausola BODY ART (ora `Vogue_202.py`, `Atelier_205.py` — stesso codice della clausola, solo rinominati dal successivo bump del 13/07) è stato provato su Koyeb. Da verificare: (a) foto senza tatuaggi → prompt più corto, clausola assente; (b) foto con tatuaggi (es. quella del 07/07) → clausola presente, fedeltà come già vista su Atelier 203.
