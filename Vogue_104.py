...
from C_shared100 import VALERIA_DNA, generate_caption, generate_mini_caption, generate_mini_prompt, review_and_fix, sanitize_user_input, SHARED_VERSION, SHARED_DATE
...
def handle_photo(m):
    ...
    bot.send_message(m.chat.id, CaptionGenerator.local(prompt))
