...
**Generato:** 17/07/2026, fine sessione (aggiornato da versione 15/07)
**Da:** Walter Caponi
...
## 2. STATO FILE ATTUALE (17/07/2026)

| File | Versione | Koyeb service | Run command | Chiavi API |
|------|---------|---------------|--------------|-----------|
| `C_shared100.py` | **2.4.0** | (comune a tutti) | — | — |
...
| `Atelier_250.py` | **2.5.0** | flexible-denna/atelier | `python Atelier_250.py` | 5 |
...
## 7. ATELIER — STORICO E STATO (v2.5.0)
