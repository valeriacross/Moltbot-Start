...
LOCATION_POOL = LOCATION_POOL = [
    ("🇮🇹 · Certaldo, borgo medievale toscano", "Certaldo, Tuscan medieval hilltop village, cobblestone streets and terracotta rooftops"),
    ("🇮🇹 · Portofino, borgo ligure", "Portofino, Ligurian harbour village, colourful fishermen's houses and crystal-clear bay"),
    ("🇵🇹 · Penisola di Tróia, Setúbal", "Troia Peninsula, Setúbal, pristine Atlantic beach, white sand dunes and turquoise water"),
    ("🇵🇹 · Santa Cruz de Torres Vedras, costa atlantica", "Santa Cruz de Torres Vedras, Portuguese coastal town, sandy cliffs and Atlantic promenade"),
...
OUTFIT_POOL = [
    ...
    ("Versace · plunge sequined mini · ruby red",  "ruby red Versace deep-plunge sequined mini, structured bust, gold Medusa medallion, red stiletto sandals, bold gold hoops"),
    ("Jacquemus · micro halter · nude sand",  "nude sand Jacquemus micro halter mini, single twisted strap, bare back, nude pointed mules, delicate gold chain"),
    ("Tom Ford · satin plunge mini · midnight navy",  "midnight navy Tom Ford satin plunge mini, deep V neckline, structured hips, navy pointed heels, diamond ear drops"),
    ("Bottega Veneta · intreccio bodycon · caramel",  "caramel Bottega Veneta intreccio-weave bodycon mini, structured knit, bare shoulders, tan leather slides, single gold cuff"),
    ("Vivienne Westwood · corset mini · black tartan",  "black tartan Vivienne Westwood boned corset mini, asymmetric draped hem, platform boots, safety-pin earrings"),
    ("Dolce & Gabbana · lace bandeau mini · blush",  "blush Dolce & Gabbana lace bandeau mini, structured strapless, lace-trim hem, nude strappy heels, pearl drop earrings"),
    ("Zimmermann · floral micro · cherry blossom",  "cherry blossom Zimmermann floral micro mini, puff sleeves, deep V, strappy white block heels, crystal ear studs"),
    ("Cult Gaia · structured cage mini · ivory",  "ivory Cult Gaia structured cage mini, architectural bamboo-inspired frame, bare skin panels, ivory block sandals, no jewellery"),
    ("Christopher Esber · cut-out drape · sand",  "sand Christopher Esber asymmetric cut-out mini, draped one shoulder, strategic side opening, nude block heels, single pearl"),
    ("Nensi Dojaka · butterfly mesh mini · black",  "black Nensi Dojaka butterfly mesh micro mini, sheer body panels with butterfly silk inserts, stilettos, ear studs"),
    ("David Koma · spiral cut-out mini · champagne",  "champagne David Koma spiral cut-out mini, metallic fabric, architectural waist openings, champagne stiletto heels, ear climbers"),
]
