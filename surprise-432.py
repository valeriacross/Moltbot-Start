...
def analyze_photo_location(photo_bytes, mime_type="image/jpeg"):
    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            contents=[
                photo_p,
                "Analyze this location image. Return EXACTLY this structure in this order:\n"
                "MAIN SUBJECT: [The dominant element — monument, landscape, building, natural phenomenon. Full detail: name, shape, size, material, color]\n"
                "GROUND: [Exact surface underfoot — material, color, texture, pattern. e.g. 'white marble tiles with black wavy inlay, geometric mosaic pattern']\n"
                "SKY: [Sky condition, colors, clouds, phenomena — star trails, aurora, fog, storm, blue hour gradient, golden haze. Full detail.]\n"
                "COLORS: [List every dominant color with descriptors — warm golden yellow, terracotta orange, deep cobalt blue, chalk white, ochre, magenta]\n"
                "LIGHTING: [Light source, direction, quality, mood — artificial uplighting, backlit sunset, long exposure night, overcast diffused, neon glow]\n"
                "SURROUNDINGS: [Trees, vegetation, water, architecture, people, objects visible in mid and background]\n"
                "ATMOSPHERE: [Emotional mood of the place — monumental, desolate, cosmic, romantic, dramatic, surreal, intimate, majestic]\n"
                "Do NOT describe any person, face, or body."
            ],
            config=genai_types.GenerateContentConfig(
                temperature=0.2,
