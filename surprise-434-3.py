...
def handle_callback(call):
    ...
    # Guard: ignora mode_auto/mode_manual da vecchi messaggi se non c'è sessione attiva
    if data in ("mode_auto", "mode_manual") and not any([
        last_scenario.get(uid),
        manual_state.get(uid),
        awaiting_photo.get(uid),
    ]):
        # Rimanda alla domanda foto — nuovo flusso corretto
