...
def _flag_mini_prompt() -> str:
    """Mini prompt statico per il flag — non usa il parser generico."""
    return (
        "🏳️\u200d🌈 <b>PRIDE! Mosaic — 6 pannelli 3×2</b>\n"
        "🅿️ P — Rosso — abito + lettera\n"
        "🇷 R — Arancione — abito + lettera\n"
        "🇮 I — Giallo — abito + lettera\n"
        "🇩 D — Verde — abito + lettera\n"
        "🇪 E — Blu — abito + lettera\n"
        "❗ ! — Viola — abito + lettera\n"
        "👗 Abiti estivi svolazzanti, colore pannello\n"
        "💃 Pose celebrative diverse per pannello\n"
        "🖋 Lettera bold sans-serif, pastello su sfondo saturo\n"
        "📐 Layout 3×2 seamless, no bordi"
    )
...
def _flag_send_prompt(cid, uid):
    ...
    # Mini prompt statico dedicato
    bot.send_message(cid, _flag_mini_prompt(), parse_mode="HTML")
