...
**Generato:** 05/08/2026, fine sessione (aggiornato da versione 02/08)
**Da:** Walter Caponi
...
## 2. STATO FILE ATTUALE (05/08/2026)

| File | Versione | Koyeb service | Run command | Chiavi API |
|------|---------|---------------|--------------|-----------|
| `C_shared100.py` | **2.4.12** | (comune a tutti) | — | — |
| `Vogue_220.py` | **2.2.0** | colossal-giselle/vogue | `python Vogue_220.py` | 2 |
