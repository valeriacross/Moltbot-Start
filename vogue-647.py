...
def generate_caption_from_image(img_bytes):
    """Genera caption social dall'immagine — logica identica ad Architect."""
    try:
        caption_instr = (
            "Generate a social media caption. "
            "Format: 3-5 contextual emojis + a short phrase of maximum 10 words. "
        ...
        response = client.models.generate_content(
            model=MODEL_TEXT_ID,
            contents=["Analyze this image and " + caption_instr, img_part]
        )
        if response.text:
