    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            contents=[
                ...
                "IMPORTANT: focus ONLY on the outfit, clothing, colors, textures, location or setting. "
                "Do NOT mention the person, their age, gender, face, or body. "
                "1 complete sentence in English, 4-6 emojis, evocative fashion-forward tone. "
...
def handle_choice(call):
    ...
    if call.data == "choice_faceswap":
        ...
        def do_faceswap():
            ...
            if caption_fs:
                bot.send_message(cid, f"{caption_fs}\n#genderfluid #selfexpression #bodypositivity")
