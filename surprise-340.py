...
LOCATION_POOL = LOCATION_POOL = [
    ...
    ("🇮🇹", "Certaldo, Tuscan medieval hilltop village, cobblestone streets and terracotta rooftops"),
    ("🇵🇹", "Santa Cruz de Torres Vedras, Portuguese coastal town, sandy cliffs and Atlantic promenade"),
    ("🇵🇹", "Troia Peninsula, Setúbal, pristine Atlantic beach, white sand dunes and turquoise water"),
    ("🇮🇹", "Portofino, Ligurian harbour village, colourful fishermen's houses and crystal-clear bay"),
]
