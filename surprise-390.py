...
OUTFIT_POOL = [
    # ── BEACHWEAR (17) ─────────────────────────────────────────────────────────
    # ordinamento: stilista A→Z, poi colore
    ("Alaia · cut-out one-piece · ivory white",           "ivory white Alaia one-piece, structured V front, sculpted waist, classic cut legs, white slide sandals, gold cuff"),
    ("Dolce Gabbana · push-up bikini · black",            "black Dolce Gabbana push-up bikini, gold logo charm at hip, black jacquard sarong, gold stiletto sandals, bold hoops"),
    ...
    ("Eres · bandeau high-cut · electric turquoise",      "electric turquoise Eres bandeau bikini, high-cut bottoms, sheer turquoise pareo tied low, tan espadrille wedges"),
    ("Eres · sporty bandeau · forest green",              "forest green Eres sporty bandeau crop-top bikini, high-rise briefs, linen shirt open over shoulders, tan espadrilles, tortoiseshell sunglasses"),
    ...
    ("Hunza G · crinkle bikini · cobalt blue",            "cobalt blue Hunza G crinkle bikini, ruched bandeau top, matching high-rise briefs, cobalt espadrilles, silver anklet"),
    ("La Perla · triangle string bikini · crimson",       "crimson La Perla triangle string bikini, red cord ties, gold anklet, oversized black sunglasses"),
    ...
    ("Melissa Odabash · string bikini · bronze metallic", "bronze metallic Melissa Odabash string bikini, wide-brim bronze hat, tan leather thong sandals, layered gold chains"),
    ...
    ("Zimmermann · triangle print bikini · tropical coral","tropical coral Zimmermann triangle print bikini, ruffled top, high-waist bottoms, matching pareo wrap, cork wedge sandals, gold ring earrings"),
    # ── MINI DRESS (25) ────────────────────────────────────────────────────────
    # ordinamento: stilista A→Z, poi colore
    ("Acne Studios · wrap mini · electric teal",          "electric teal Acne Studios asymmetric wrap mini, draped one-shoulder, thigh slit, teal patent heels, single chain earring"),
    ...
    ("Chanel · tweed micro · cream black",                "cream and black Chanel tweed micro dress, structured skirt, gold chain trim, low-cut neckline, black cap-toe pumps, pearl bracelet"),
    ...
    ("Christopher Kane · lace-panel mini · ivory",        "ivory Christopher Kane lace-panel micro mini, semi-opaque geometric inserts, structured bodice, nude platform heels, pearl cluster earrings"),
    ...
    ("Dior · Bar micro · navy midnight",                  "navy midnight Dior Bar-inspired micro, structured nipped waist, flared mini skirt, navy pointed pumps, pearl choker, white gloves"),
    ...
    ("Isabel Marant · slip micro · warm amber",           "warm amber Isabel Marant silk slip micro, bias-cut, thin spaghetti straps, open back, amber flat sandals, layered gold chains"),
    ...
    ("Alaia · laser-cut bodycon · deep violet",           "deep violet Alaia laser-cut bodycon, geometric laser-cut openwork, violet patent heels, single silver cuff"),
    ("Bottega Veneta · slip dress · moss green",          "moss green Bottega Veneta slip dress, cowl back, bare shoulders, tan leather mules, gold cuff"),
    ("Faithfull · broderie sundress · powder blue",       "powder blue Faithfull broderie sundress, mini length, puff sleeves, white block heels, pearl studs"),
    # ── FUTURISTA / SCI-FI (10) ────────────────────────────────────────────────
    # ordinamento: stilista A→Z, poi colore
    ...
    ("Mugler · hourglass cut-out · matte black",          "matte black Mugler hourglass cut-out bodycon dress, spiral waist openings, structured panels, black stiletto boots"),
    ...
    # ordinamento: era/brand A→Z, poi colore
    ("1920s · Charleston · champagne sequined",           "champagne sequined 1920s Charleston dress, fringed hem, sleeveless, V back, champagne heels, rhinestone headpiece"),
    ...
    ("Art Deco · drop-waist · midnight blue",             "midnight blue Art Deco beaded drop-waist dress, geometric pattern, silver fringe, silver T-bar heels, feathered headpiece"),
    ("Gatsby · bias-cut satin · ivory",                   "ivory 1920s Gatsby-era bias-cut satin mini dress, cowl neckline, beaded shoulder straps, ivory heels, diamond headband"),
    ("Vionnet · silk charmeuse · pale gold",              "pale gold Vionnet-inspired silk charmeuse bias-cut mini, fluid drape, backless, gold sandals, long pearl necklace"),
    # ── RETRÒ ANNI '70 / GLAM ROCK / DISCO (5) ────────────────────────────────
    # ordinamento: brand A→Z, poi colore
    ("Biba · op-art mini · black white",                  "black and white Biba op-art geometric micro mini, bold graphic print, high neck, white platform ankle boots, round white sunglasses"),
    ("Biba · satin halter · burnt sienna",                "burnt sienna Biba 1970s satin deep-V halter disco mini, cowl front, bare back, platform sandals, long pendant earrings"),
    ...
    ("Pucci · bold graphic print · electric",             "electric Pucci 1970s bold graphic-print mini dress, signature swirling pattern, platform wedges, oversized sunglasses"),
    ...
    ("Jean Paul Gaultier · cone bra corset · gold",       "gold satin Jean Paul Gaultier iconic cone bra corset mini dress, structured pointed bust, gold stilettos, theatrical makeup"),
    ("Junya Watanabe · patchwork micro · indigo",         "indigo patchwork Junya Watanabe denim micro mini, mixed texture panels, deconstructed seams, white platform boots, no jewellery"),
    ("Maison Margiela · trompe l oeil · nude illusion",   "nude illusion Maison Margiela trompe l oeil micro, body-print optical illusion fabric, trompe-l-oeil texture, nude heels, minimalist"),
    # ── COSTUMI / TEATRALI (8) ─────────────────────────────────────────────────
    # ordinamento: nome personaggio/stile A→Z
    ...
    ("Butterfly · ombré silk micro · aurora borealis",    "aurora borealis ombré silk micro dress, theatrical fashion costume, iridescent teal to violet gradient, sculptural collar, crystal platform heels"),
    ...
    ("Odalisque · brocade micro · ruby red",              "ruby red orientalist fashion micro, richly embroidered brocade bodice, layered silk skirt panels, jewelled belt, flat embroidered slippers, chandelier earrings"),
    ...
    ("Basic Instinct · wrap mini · chalk white",          "chalk white Basic Instinct-inspired structured wrap mini dress, sharp lapels, belted waist, white stiletto heels, no jewellery, icy gaze"),
    ("Black Swan · structured tutu · pure white",         "pure white Black Swan structured tutu bodysuit, fitted corseted bodice, sculpted tulle skirt, white satin pointe heels, feather crown headpiece"),
    ("Breakfast at Tiffany · LBD · black",                "iconic black Givenchy Breakfast at Tiffany LBD, sleeveless column mini silhouette, opera gloves, tiara, pearl necklace, upswept hair"),
    ("Cleopatra · pleated linen micro · white gold",      "white gold pleated Cleopatra-inspired linen wrap micro, wide metallic collar, gold ankle cuffs, flat gold sandals, kohl eye makeup"),
    ...
    ("Gentlemen Prefer Blondes · pink satin · hot pink",  "hot pink strapless satin micro dress from Gentlemen Prefer Blondes, structured sweetheart bust, pink satin gloves, diamond chandelier earrings, pink heels"),
    ...
    ("Metropolis · machine-woman · polished silver",      "polished silver Metropolis-inspired fashion editorial bodysuit, riveted metal panels, structured breast plate, silver thigh-high boots, silver crown"),
    ("Monroe · subway dress · white",                     "white halter pleated Marilyn Monroe subway dress, billowing skirt, white stiletto heels, diamond drop earrings"),
    ("Pretty Woman · red corseted mini · scarlet red",    "scarlet red Pretty Woman strapless corseted mini dress, structured bodice, full mini skirt, red satin heels, long gloves, diamond drop earrings"),
    ("Zoolander · space disco · chrome silver",           "chrome silver Zoolander-inspired space disco micro dress, metallic sheen, structured shoulders, silver platform boots, dramatic silver eye makeup"),
]
...
POSE_POOL = [
    ...
    ("🪑 Accovacciata · mani a terra",          "crouching low, knees apart, hands on ground between feet"),
    # ── DISTESA ────────────────────────────────────────────────────────────────
...
LABEL_WIDTH = 38  # larghezza uniforme label in caratteri
