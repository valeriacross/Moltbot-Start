...
OUTFIT_POOL = [
    ...
    "fuchsia Jacquemus Le Chiquito mini dress, asymmetric neckline, bare shoulders",
    "white broderie Chloé strapless mini dress, deep sweetheart, golden tan skin",
    "bronze metallic Saint Laurent mini shift dress, spaghetti straps, bare legs",
    "black Coperni cut-out mini dress, architectural waist opening, heels",
    "coral ruffled Self-Portrait mini dress, tiered hem, plunging back",
    "red satin Rick Owens draped mini, thigh-high slit, one shoulder",
    # Abiti da sera aggiuntivi
    "ivory Valentino Haute Couture column gown, structured bust, deep V back",
    "cobalt blue Safiyaa off-shoulder gown, thigh slit, draped skirt",
    "black velvet Tom Ford gown, deep plunge neckline, long sleeves, slit",
    "rose gold sequined Naeem Khan floor gown, open back, high slit",
    "nude illusion Zuhair Murad gown, crystal embroidery, sheer bodice",
    ...
    # Estivi aggiuntivi
    "sheer printed Etro maxi dress, side slit, bare midriff, bohemian",
    "cobalt blue MSGM micro skirt, matching crop halter top, mule heels",
    "olive green Bottega Veneta slip dress, cowl neckline, bare back",
    "orange tie-dye Dries Van Noten mini dress, deep V, statement earrings",
    # Cut-out aggiuntivi
    "beige Mugler hourglass bodycon dress, waist cut-outs, sheer panels",
    "black PVC Versace bodysuit, plunging neckline, micro skirt, thigh-highs",
    "silver Rabanne chainmail micro dress, bare shoulders and hips",
    "red Alaïa laser-cut bodycon dress, geometric openwork, bare skin visible",
]
