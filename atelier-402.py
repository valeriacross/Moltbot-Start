...
from shared import VALERIA_FACE, VALERIA_BODY_STRONG, VALERIA_BODY_SAFE, VALERIA_WATERMARK, VALERIA_NEGATIVE
...
def generate_caption_from_prompt(outfit_desc, filter_key=None, settings=None):
    """→ shared.CaptionGenerator.from_scenario() con testo libero."""
    scenario = {"outfit": outfit_desc or "high-fashion editorial scene"}
