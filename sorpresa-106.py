...
VARIABILI = {
    ...
    "outfit_top": [
        ...
        "embroidered kimono jacket, open front", "flowing chiffon wrap top",
        "sculptural architectural blazer, no shirt underneath", "backless halter neck top",
        "draped one-shoulder top", "lace-up corset top in satin",
    ...
    "outfit_bottom": [
        ...
        "ruffled mini skirt in organza", "leather mini skirt with zipper detail",
        "pleated tennis skirt in white"
    ],
    "scarpe": [
