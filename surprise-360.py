...
OUTFIT_POOL = [
    ...
    ("Iris van Herpen · liquid polymer · molten silver", "molten silver Iris van Herpen liquid-polymer gown, fluid metallic drape, transparent panels, chrome platform heels"),
    ...
    ("Balenciaga · inflated cocoon · neon orange",       "neon orange Balenciaga inflated cocoon silhouette dress, sculptural volume, matching orange boots, minimalist"),
    ("Coperni · spray-on liquid dress · pure white",     "pure white Coperni spray-on micro dress, body-molded, seamless, barely-there, white stiletto heels"),
    ("Y Project · deconstructed suit · chrome silver",   "chrome silver Y Project deconstructed asymmetric suit, exposed seams, one-shoulder, silver boots, industrial"),
    ...
    ("Rick Owens · sculptural draped · ashen white",     "ashen white Rick Owens sculptural asymmetric draped mini, architectural volume, white leather platform boots"),
    # ── RETRO ANNI 20 (5) ────────────────────────────────────
    ("Art Deco · flapper dress · gold beaded",           "gold beaded Art Deco flapper dress, fringe hem, dropped waist, intricate beadwork, T-strap gold heels, long pearl rope, feather headband"),
    ("1920s · Charleston dress · champagne sequined",    "champagne sequined 1920s Charleston dancing dress, fringed hem, sleeveless, V back, champagne heels, rhinestone headpiece"),
    ...
    ("Art Nouveau · beaded drop-waist · midnight blue",  "midnight blue Art Nouveau beaded drop-waist dress, geometric Art Deco pattern, silver fringe, silver T-bar heels, feathered headpiece"),
    ("Vionnet · silk charmeuse · pale gold",             "pale gold 1920s Vionnet-inspired silk charmeuse bias-cut dress, fluid drape, backless, gold sandals, long pearl necklace"),
    # ── RETRO ANNI 70 (5) ────────────────────────────────────
    ...
    ("Ossie Clark · printed chiffon · psychedelic",      "psychedelic printed Ossie Clark 1970s chiffon wrap mini, plunging V, flutter sleeves, platform sandals, statement sunglasses"),
    ...
    ("YSL · safari mini · camel suede",                  "camel suede Saint Laurent 1970s safari mini dress, belted waist, patch pockets, thigh-high suede boots, wide-brim hat"),
    ...
    # ── AVANGUARDIA E SCENOGRAFIA (10) ───────────────────────
    ("Valentino HCouture · ruffled cocoon · candy pink",  "candy pink Valentino Haute Couture giant ruffled cocoon dress, multiple tiered ruffle layers, sculptural volume, pink satin heels"),
    ("Giambattista Valli · tulle cloud · hot pink",       "hot pink Giambattista Valli enormous tulle ball gown mini, cloud of tulle layers, bare shoulders, pink stilettos"),
    ("Viktor Rolf · upside-down ruffle · electric blue",  "electric blue Viktor and Rolf architecturally deconstructed ruffle dress, upside-down collar, sculptural bow, blue heels"),
    ("Schiaparelli · surrealist lobster · ivory",         "ivory Schiaparelli surrealist sculptural mini dress, gold lobster applique, draped satin, gold heeled sandals"),
    ("Vivienne Westwood · tartan corset · royal",         "royal tartan Vivienne Westwood corseted mini, structured boning, asymmetric bustle, platform shoes, punk accessories"),
    ("Alexander McQueen · armadillo mini · black",        "black Alexander McQueen structural mini with dramatic winged shoulders, intense armour-like silhouette, McQueen armadillo heels"),
    ...
    # ── FILM ICONICI (10) ────────────────────────────────────
    ("Breakfast at Tiffany · LBD Givenchy · black",       "iconic black Givenchy Breakfast at Tiffany LBD, sleeveless column silhouette, opera gloves, tiara, pearl necklace, upswept hair"),
    ...
    ("Grease · skin-tight pants · glossy black",          "glossy black skin-tight Grease-style latex pants, off-shoulder top, red stilettos, red lips, retro sunglasses"),
    ("Moulin Rouge · showgirl · crimson feathers",        "crimson burlesque Moulin Rouge showgirl costume, feathered headdress, sequined corset, fishnet, red heels, dramatic eye makeup"),
    ("Atonement · silk bias-cut · emerald green",         "emerald green silk bias-cut Atonement-style evening dress, plunging back, 1930s silhouette, satin heels, pearl drop earrings"),
    ("Cleopatra · pleated linen · white gold",            "white gold pleated Cleopatra-inspired linen wrap dress, wide metallic collar, gold ankle cuffs, flat gold sandals, kohl eye"),
    ("Barbarella · space vinyl · silver",                 "silver Barbarella-style space-age vinyl micro outfit, breastplate, thigh-high boots, futuristic accessories, dramatic hair"),
    ("Chicago · showgirl sequined · jet black",           "jet black Chicago showgirl sequined bodysuit, top hat, fishnet stockings, black character heels, red lipstick, smoky eye"),
    ("Cabaret · showgirl · black lingerie",               "black Cabaret showgirl silk lingerie set, suspenders, fishnets, bowler hat, black heels, dramatic stage makeup, long earrings"),
    ("Romeo Juliet · Renaissance velvet · midnight blue", "midnight blue Renaissance velvet corseted gown, embroidered bodice, puffed sleeves, medieval braid, velvet slippers, pearl net"),
    # ── ESTIVI / LEGGEREZZA (10) ─────────────────────────────
    ...
    ("Dries Van Noten · midi wrap · warm terracotta",     "warm terracotta Dries Van Noten printed midi wrap dress, deep V, flutter sleeves, tan heeled sandals, ceramic hoops"),
