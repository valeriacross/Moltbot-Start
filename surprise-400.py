...
LOCATION_ANALYZE_PROMPT = (
    ...
    "Analyze this photo and describe the location in a single line of comma-separated English keywords. "
    "Focus on: setting type, dominant colors, architectural or natural elements, atmosphere, lighting. "
    "Max 25 words. No sentences. Only commas. No punctuation at the end.\n"
    "Example: sun-drenched rooftop terrace, terracotta tiles, city panorama, warm afternoon light, Mediterranean\n"
    "Example: rocky Atlantic coastline, dramatic waves, overcast sky, wild and stormy\n"
    "Return ONLY the keyword line, nothing else."
)
