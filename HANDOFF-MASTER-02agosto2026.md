...
**Generato:** 02/08/2026, fine sessione (aggiornato da versione 01/08)
**Da:** Walter Caponi
...
## 2. STATO FILE ATTUALE (02/08/2026)

| File | Versione | Koyeb service | Run command | Chiavi API |
|------|---------|---------------|--------------|-----------|
| `C_shared100.py` | **2.4.10** | (comune a tutti) | — | — |
...
| `Atelier_261.py` | **2.6.1** | flexible-denna/atelier | `python Atelier_261.py` | 5 |
...
## 4. C_SHARED100.PY — STORICO COMPLETO FIX (v2.3.0 → v2.4.10)
