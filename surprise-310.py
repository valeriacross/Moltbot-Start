...
LOCATION_POOL = [
    ...
    ("Lucca · mura rinascimentali, torri",     "Lucca Renaissance city walls, medieval towers, tree-lined ramparts, Tuscany"),
    ("Verona · Arena romana, piazza Bra",      "Verona Roman Arena, Piazza Bra, warm stone, golden evening light"),
    ("Padova · Prato della Valle, canale",     "Padova Prato della Valle, elliptical square, statues, canal, afternoon"),
    ("Messina · Duomo, orologio astronomico",  "Messina Cathedral, Gothic facade, astronomical clock tower, Sicily, blue sky"),
    ("Sardinia · Costa Paradiso, rocce rosse", "Costa Paradiso, Sardinia, dramatic red granite rocks, turquoise sea, wild coast"),
    ("Sardinia · S'Archittu, arco marino",     "S'Archittu natural sea arch, Sardinia, limestone rock, emerald water below"),
    ("Sicily · Cave Alcantara, basalto",       "Alcantara Gorge, Sicily, black basalt columns, crystal river, dramatic canyon"),
    ("Lampedusa · Isola dei Conigli, spiaggia","Lampedusa Isola dei Conigli beach, protected nature reserve, white sand, turquoise"),
    # ── PORTOGALLO (20) ──────────────────────────────────────
...
# --- OUTFIT POOL (50) ---
# Rimossi: tutti i GOWN (12), Etro maxi, Dries Van Noten midi, Saint Laurent shorts
# Aggiunti: futurista, retrò '20/'70, avanguardia, costumi cinematografici
OUTFIT_POOL = [
    # ── MINI DRESS (12) ──────────────────────────────────────
    ...
    # ── RETRÒ ANNI '70 / GLAM ROCK / DISCO (3) ───────────────
