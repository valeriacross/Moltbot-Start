...
VALERIA_BODY_STRONG = (
    ...
    "They MUST coexist in the same image. The beard stays. The feminine body stays. Both are mandatory. "
    "Do NOT resolve this by removing the beard. Do NOT resolve this by masculinizing the body. Keep both exactly as described.\n\n"
)
...
def handle_callbacks(call):
    ...
    # Riprova
        ...
        def retry_task():
            t = time.time()
            img, err = None, "Generazione immagini disabilitata — usa Flow."
