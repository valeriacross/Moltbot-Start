...
LOCATION_POOL = [
    ...
    ("Rome · Piazza di Spagna, dawn",             "Piazza di Spagna, Rome, Spanish Steps empty at dawn, pale rose light"),
    ("Rome · Castel Sant'Angelo, river view",     "Castel Sant'Angelo, Rome, Tiber river at golden hour, dramatic silhouette"),
    ("Rome · Villa Borghese, pine terrace",       "Villa Borghese gardens, Rome, umbrella pines, panoramic terrace, afternoon"),
    ...
    ("Florence · Boboli Gardens, baroque",        "Boboli Gardens, Florence, baroque terraces, cypress alleys, afternoon"),
    ("Florence · Palazzo Pitti, courtyard",       "Palazzo Pitti courtyard, Florence, rusticated stone, Renaissance symmetry"),
    ("Florence · Bargello, arcaded courtyard",    "Bargello museum arcaded courtyard, Florence, medieval stone, warm light"),
    ...
    ("Venice · Rialto Bridge, Grand Canal",       "Venice Rialto Bridge, Grand Canal below, market arches, morning light"),
    ("Venice · Arsenale, brick arches",           "Venice Arsenale entrance, monumental brick arches, still water"),
    ("Venice · San Giorgio Maggiore, lagoon",     "San Giorgio Maggiore island church, Venice lagoon, misty dawn"),
    ...
    ("Milan · Galleria Vittorio Emanuele, dome",  "Galleria Vittorio Emanuele II, Milan, glass dome, mosaic floors, golden light"),
    ...
    ("Naples · Castel dell'Ovo, harbour",         "Castel dell'Ovo, Naples harbour, volcanic rock, Vesuvius horizon"),
    ...
    ("Lake Maggiore · Isola Bella, terrazze",     "Isola Bella, Lago Maggiore, baroque terraced gardens, lake panorama"),
    ("Lake Orta · San Giulio island, mist",       "Lake Orta, Isola di San Giulio, misty morning, Romanesque basilica"),

    # ── Dolomiti & Alpi (4) ───────────────────────────────────────
    ("Dolomites · Tre Cime di Lavaredo",          "Dolomites Tre Cime di Lavaredo, dramatic rock spires, clear sky"),
    ("Dolomites · Lago di Braies, pine forest",   "Lago di Braies, Dolomites, emerald alpine lake, pine forest, reflection"),
    ("Dolomites · Alpe di Siusi, dawn meadow",    "Alpe di Siusi, Dolomites, alpine meadow at dawn, pink rock peaks"),
    ("Aosta Valley · Forte di Bard, medieval",    "Forte di Bard, Valle d'Aosta, dramatic medieval fortress, mountain pass"),

    # ── Toscana (8) ───────────────────────────────────────────────
    ("Florence · Piazzale Michelangelo, sunset",  "Piazzale Michelangelo, Florence, sunset panorama, terracotta rooftops"),
    ("Pisa · Piazza dei Miracoli, Campo Santo",   "Pisa Piazza dei Miracoli, Leaning Tower, marble cathedral, green lawn"),
    ...
    ("Lisbon · Chiado, tram yellow, tiles",       "Lisbon Chiado, yellow tram on cobblestones, azulejo facades, afternoon"),
    ("Lisbon · LX Factory, corrugated iron",      "Lisbon LX Factory, industrial corrugated iron, street art, warm evening"),
    ("Lisbon · Marquês de Pombal, boulevard",     "Lisbon Marquês de Pombal, wide boulevard, jacaranda trees, spring"),
    ...
    ("Sintra · Monserrate Palace, garden",        "Sintra Monserrate Palace, romantic neo-Gothic, exotic garden, morning"),
    ...
    ("Porto · Foz do Douro, Atlantic mouth",      "Foz do Douro, Porto, river meets Atlantic, dramatic surf, golden hour"),
    ...
    ("Tomar · Convento de Cristo, Templar",       "Convento de Cristo, Tomar, Templar round church, Manueline window"),
    ...
    ("Sagres · Fortaleza, Atlantic cliffs",       "Sagres Fortress, Cabo de São Vicente, Atlantic cliffs, dramatic wind"),
    ...
    # ── Azzorre (6) ───────────────────────────────────────────────
    ("Azores · Sete Cidades, twin lakes",         "Sete Cidades, São Miguel, twin crater lakes, volcanic green rim"),
    ("Azores · Caldeira do Faial, volcanic",      "Caldeira do Faial, Azores, volcanic crater, wild vegetation, mist"),
    ("Azores · Lagoa do Fogo, summit",            "Lagoa do Fogo, São Miguel, Azores, volcanic summit lake, clear sky"),
    ("Azores · Praia do Porto Pim, crescent",     "Porto Pim beach, Faial, Azores, crescent bay, volcanic backdrop"),
    ("Azores · Furnas hot springs, steam",        "Furnas thermal springs, São Miguel, Azores, steam rising, lush green"),
    ("Azores · Flores, waterfall canyon",         "Poço do Bacalhau waterfall, Flores, Azores, lush canyon, turquoise pool"),

    # ── Madeira (5) ───────────────────────────────────────────────
    ("Madeira · Cabo Girão, cliff vertiginous",   "Cabo Girão, Madeira, highest sea cliff in Europe, glass skywalk, Atlantic"),
    ...
    ("Madeira · Ponta de São Lourenço, coast",    "Ponta de São Lourenço, Madeira, dramatic rocky peninsula, Atlantic blue"),
    ("Madeira · Pico do Arieiro, clouds below",   "Pico do Arieiro, Madeira, mountain peaks above clouds, sunrise pink"),

    # ── Nord Portogallo (5) ───────────────────────────────────────
    ("Braga · Bom Jesus, baroque staircase",      "Bom Jesus do Monte, Braga, baroque zigzag staircase, pilgrimage church"),
    ("Guimarães · castle, birthplace Portugal",   "Guimarães Castle, medieval fortress, birthplace of Portugal, blue sky"),
    ("Viana do Castelo · Santa Luzia basilica",   "Santa Luzia Basilica, Viana do Castelo, hilltop, Lima river panorama"),
    ("Ponte de Lima · oldest town, arched bridge","Ponte de Lima, oldest town Portugal, medieval arched bridge, green river"),
    ("Peneda-Gerês · waterfalls, granite",        "Peneda-Gerês national park, Portugal, granite waterfalls, wild oak forest"),

    # ── Centro Portogallo (4) ─────────────────────────────────────
    ("Coimbra · Universidade, biblioteca joanina","Coimbra University, Biblioteca Joanina, Baroque interior, gilded wood, warm glow"),
    ("Batalha · Mosteiro, rendella gotica",       "Mosteiro da Batalha, Portugal, Gothic lace stonework, royal pantheon, afternoon"),
    ("Setúbal · Arrábida, scogliere e mare",      "Arrábida Natural Park, Setúbal, dramatic white limestone cliffs, emerald sea"),
    ("Torres Vedras · linhas de defesa, colline", "Torres Vedras, Portugal, Napoleonic defence lines, rolling hills, golden afternoon"),
    ...
    ("India · Jaipur, Hawa Mahal, façade",        "Hawa Mahal, Jaipur, India, honeycomb sandstone facade, blue sky"),
    ...
    ("China · Terracotta Army, Xi'an",            "Terracotta Army pits, Xi'an, China, rows of warrior figures, amber"),
    ("Japan · Kyoto, Fushimi Inari torii",        "Fushimi Inari shrine, Kyoto, endless red torii gates, misty forest path"),
    ("Japan · Kyoto, Arashiyama bamboo grove",    "Arashiyama bamboo grove, Kyoto, towering green culms, filtered light"),
    ("Japan · Mount Fuji, cherry blossoms",       "Mount Fuji, Japan, cherry blossom foreground, Kawaguchiko lake reflection"),
    ...
    ("Germany · Neuschwanstein, alpine forest",   "Neuschwanstein Castle, Bavaria, fairytale towers, alpine forest"),
    ...
    ("Brazil · Baia do Sancho, cliff descent",    "Baia do Sancho, Fernando de Noronha, Brazil, lush cliff, turquoise"),
    ...
    ("Maldives · overwater bungalow, lagoon",     "Maldives overwater bungalow, crystal lagoon, turquoise infinity, sunset"),
]
