...
FILTERS = {
    ...
    "y2k_pop_collage": {
        ...
        "prompt": (
            ...
            "Panel 1 — Close-up: tight face and hands framing, subject has both hands raised to face "
            "with open mouth playful expression, bratty attitude, direct eye contact. "
            "Panel 2 — Crouching: full body crouching pose, knees folded inward, eyes dramatically "
            "closed, chin slightly down, arms loosely draped over knees. "
            "Panel 3 — Standing sporty: full body standing model pose, one hand on hip, "
            "slight torso twist showing silhouette, confident neutral expression. "
            "Panel 4 — Distorted lens: dynamic perspective with one arm and hand fully extended "
            "toward the camera creating exaggerated wide-angle distortion fashion-lens effect, "
            "rest of body receding dramatically behind. "
            "Panel 5 — Seductive crouch: low crouching pose, direct intense eye contact with camera, "
            "chin slightly forward, one hand resting on knee. "
