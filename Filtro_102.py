...
_MINIFIG_LOCATIONS = [
    "LEGO City fashion boulevard — colorful brick storefronts, tiny lamp posts, bright primary-color flags",
    "LEGO Friends beach resort — turquoise brick water, yellow sand plates, striped parasols",
    "LEGO Friends dreamhouse living room — pink and white brick walls, tiny furniture, heart-shaped windows",
    "LEGO City rooftop garden — green plate grass, brick flower boxes, city skyline of bricks in background",
    "LEGO botanical garden — oversized brick flowers in primary colors, arched greenhouse of transparent bricks",
    "LEGO City shopping mall — escalators built from bricks, tiny shopfront signs, checkered tile floor",
    "LEGO art gallery — white brick walls, tiny framed artworks, black-and-white tile floor, gallery lighting",
    "LEGO yacht harbor — blue plate water, white brick boats with sail elements, orange sunset sky",
    "LEGO outdoor café — tiny round tables with umbrella poles, brick cobblestone, potted brick plants",
    "LEGO music festival stage — colorful speaker stacks of bricks, crowd of minifig tiles, colored spotlights",
    "LEGO Friends pool party — bright blue water tiles, inflatable elements, pink and yellow deck chairs",
    "LEGO City park — green base plate grass, brick trees with round foliage, winding brick path",
    "LEGO Creator medieval courtyard — stone-grey brick walls, arched windows, cobblestone floor tiles",
    "LEGO City runway at fashion week — white brick catwalk, seated minifig audience tiles, camera flashes",
]
