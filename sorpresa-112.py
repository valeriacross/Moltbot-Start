...
def estrai_combinazione():
    ...
    10. FX con sfondo proprio → neutralizza sfondo terrestre (sostituisce con white seamless studio)
    """
    ...
    # 9. Calcola formato ottimale in base alla combo finale (dopo asse 10)
